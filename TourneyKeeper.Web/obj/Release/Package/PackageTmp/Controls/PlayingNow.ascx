<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PlayingNow.ascx.cs" Inherits="TourneyKeeper.Web.Controls.PlayingNow" %>
    ...
    <Columns>
        ...
        <asp:TemplateField HeaderText="Country" SortExpression="Country">
            <HeaderTemplate>
                ...
                <br />
                <asp:DropDownList ID="ddCountry" ClientIDMode="Static" ForeColor="Black" Width="60" CssClass="mdb-select colorful-select dropdown-primary md-form"
                    AutoPostBack="true"
                    runat="server" />
            </HeaderTemplate>
            <ItemTemplate>
        ...
        <asp:TemplateField HeaderText="Game system" SortExpression="GameSystem">
            <HeaderTemplate>
                ...
                <br />
                <asp:DropDownList ID="ddGameSystem" ClientIDMode="Static" ForeColor="Black" Width="60" CssClass="mdb-select colorful-select dropdown-primary md-form"
                    AutoPostBack="true"
